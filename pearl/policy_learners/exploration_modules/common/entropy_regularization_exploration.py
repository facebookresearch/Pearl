...
class EntropyRegularizationExploration(ExplorationModule):
    """
    ...
    def act(
        ...
        if values is None:
            raise ValueError("values cannot be None for entropy-based exploration")
        ...
        adjusted_probs = values + self.entropy_coeff * entropy
        ...
        return action_space.actions[action_idx].to(values.device)